...
//> using publish.name "directive-handler"
...
//> using publish.url "https://github.com/scala-cli/directive-handler"
//> using publish.versionControl "github:scala-cli/directive-handler"
